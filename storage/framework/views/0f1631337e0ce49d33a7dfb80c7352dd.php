<?php $__env->startSection('title', 'Report an Incident'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center">
                <a href="<?php echo e(route('landing')); ?>" class="mr-4 text-blue-600 hover:text-blue-800">
    ...
    <div id="successModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 hidden">
        <div class="bg-white rounded-2xl p-8 max-w-md w-full text-center">
            ...
            <div class="space-y-3">
                <a href="<?php echo e(route('landing')); ?>" class="block bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-colors">
...
<?php echo $__env->make('layouts.plain', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Pasong-Tamo\resources\views/report.blade.php ENDPATH**/ ?>